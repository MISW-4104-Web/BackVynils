...
export class DataSetup1611260351811 implements MigrationInterface {
    ...
    migration = `
        ...
        VALUES (100, 'Buscando América', 'https://i.pinimg.com/564x/aa/5f/ed/aa5fed7fac61cc8f41d1e79db917a7cd.jpg',
                '1984-08-01',
        ...
        INSERT INTO public.album(id, name, cover, "releaseDate", description, genre, "recordLabel")
        VALUES (102, 'A Night at the Opera',
                'https://upload.wikimedia.org/wikipedia/en/4/4d/Queen_A_Night_At_The_Opera.png', '1975-11-21',
        ...
        INSERT INTO public.album(id, name, cover, "releaseDate", description, genre, "recordLabel")
        VALUES (103, 'A Day at the Races',
                'https://www.udiscovermusic.com/wp-content/uploads/2019/11/a-day-at-the-races.jpg', '1976-12-10',
